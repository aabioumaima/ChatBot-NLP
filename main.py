...
Original file is located at
    https://colab.research.google.com/drive/1ZRmcgUXqNBtIF7bDPj9Ss3V5gtp0C3BI
"""
...
app = FastAPI(
    ...
    description = 'You can interact with this chatBot about the article BERT. 🚀'
    )


@app.post("/ChatBot/", tags = ['Inference'])
async def chatbot_api():
      
  f = open('.\BERT_texte.txt')
  raw_doc = f.read()
